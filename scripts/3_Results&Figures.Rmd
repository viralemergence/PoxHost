...
pcr_brts <- readRDS("/Users/katietseng/Desktop/HPC/HPC_30Jan2024/Kamiak_Results_HostTraitModel/pcr_brts.rds") 

# host susceptibility model - based on virus isolation or 'competence' data and host traits only
comp_brts <- readRDS("/Users/katietseng/Desktop/HPC/HPC_30Jan2024/Kamiak_Results_HostTraitModel/comp_brts.rds")

# pubmed/cites model - did traits predict citation counts? no, mean AUC = 0.50 (no better than chance)
pm_brts <- readRDS("/Users/katietseng/Desktop/HPC/HPC_30Jan2024/Kamiak_Results_HostTraitModel/pm_brts.rds")
...
write.csv(table_perf_metrics, "figures/supplementary/table1_perf_metrics.csv")
...
table_ts <- list("pcr" = table_ts_pcr, 
                 ...
                 "model2" = table_ts2, 
                 "model3" = table_ts3)
write.xlsx(table_ts, file = "figures/supplementary/table5_thresholdmoving.xlsx")
...
write.csv(predpfs,"figures/supplementary/table2-4_pfclades.csv")
...
png("figures/supplementary/fig_map_mpxv.png",width=6,height=8,units="in",res=600)
map_mpxv
dev.off()

pdf("figures/supplementary/fig_map_mpxv.pdf",width=6,height=8)
map_mpxv
dev.off()
...
table_rankedfeatures <- list('pcr' = ranks_pcr,
                           ...
                           'model2' = ranks_model2,
                           'model3' = ranks_model3)
write.xlsx(table_rankedfeatures, file = 'figures/supplementary/table6-7_rankedfeatures.xlsx')
...
png("figures/supplementary/fig5_boxplot_trait_ranking_model3.png",width=6.12,height=10,units="in",res=600)
...
# Combine plots and save
  library(cowplot)
  pdf("figures/supplementary/fig7_plot_pca_scoresbyspecies.pdf", width=8,height=8)
...
# Create loading plots by gene function
  ...
  library(cowplot)
  pdf("figures/supplementary/fig6_plot_pca_loadingsbyrole.pdf", width=10,height=8)
