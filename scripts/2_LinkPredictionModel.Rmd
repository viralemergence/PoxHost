...
png("figures/supplementary/s4fig_plot_cumvar_pca.png", width=4,height=4,units="in",res=600)
...
png("figures/supplementary/s10fig_boxplot_brt_tuning_link.png",width=5,height=8,units="in",res=600)
set.seed(1)
