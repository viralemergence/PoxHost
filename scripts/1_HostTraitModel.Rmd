...
png("figures/supplementary/sfig8_histogram_trait_coverage.png", width=4,height=4,units="in",res=600)
...
png("figures/supplementary/sfig9_boxplot_brt_tuning_hosttrait.png",width=5,height=8,units="in",res=600)
set.seed(1)
