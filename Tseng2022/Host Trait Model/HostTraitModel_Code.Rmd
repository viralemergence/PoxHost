...
# Create function to apply thresholds to predictions for all mammal genera and only those that are potentially unknown; use sapply to view counts
...
# Get sensitivity and specificity of model based on various optimal thresholds
