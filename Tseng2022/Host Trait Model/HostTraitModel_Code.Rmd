...
### *Model predictions: Identify taxonomic patterns via phylofactorization*
...
### *Model predictions: plot on phylogenetic tree*
...
png("Output/tree_pp_clades.png",width=12,height=8,units="in",res=300)
tree_pp_clades
dev.off()
