...
png("Output/plot_scores_pca_dim1and4_byvirus.png", width=6,height=4,units="in",res=600)
...
# Run PCA as before, but now grouping by species
pca_byspecies <- prcomp(genes[,5:985])   
...
# Plot of sequences by cluster
png("Output/plot_scores_pca_byspecies.png", width=8,height=5,units="in",res=600)
fviz_pca_ind(pca_byspecies, axes=c(1,4), geom.ind = "point", pointshape = 21, 
             pointsize = 2, 
             fill.ind = genes1$VirusSpecies, 
             col.ind = "black", 
             addEllipses = TRUE,
             label = "var",
             col.var = "black",
