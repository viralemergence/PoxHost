...
png("Output/plot_cumvar_pca.png", width=5,height=6,units="in",res=600)
plot(cumpro[0:15], xlab = "Dimension", ylab = "Proportion of explained variance")
...
m1_auc_mean <- paste0(sprintf("%.2f",mean), " \u00b1 ", formatC(se, format="e"))
...
m1_sens_mean <- paste0(sprintf("%.2f",mean), " \u00b1 ", formatC(se, format="e"))
...
m1_spec_mean <- paste0(sprintf("%.2f",mean), " \u00b1 ", formatC(se, format="e"))
...
m2_auc_mean <- paste0(sprintf("%.2f",mean), " \u00b1 ", formatC(se, format="e"))
...
m2_sens_mean <- paste0(sprintf("%.2f",mean), " \u00b1 ", formatC(se, format="e"))
...
m2_spec_mean <- paste0(sprintf("%.2f",mean), " \u00b1 ", formatC(se, format="e"))
