...
Using principal components analysis, can we distill the variables down to their most important features? Which genes contribute the most to each feature? Let's plot the loadings and also color them by functional role
...
autoplot(pca, x=1, y=4, data = genes, colour = 'VirusSpecies') 
...
# Clean dataframes of loadings and combine into sinl
  # Create a list of the positive and legative loadings
  # list_df <- ls()[grepl("_fnx", ls())]
  # list_df = lapply(list_df, get)
