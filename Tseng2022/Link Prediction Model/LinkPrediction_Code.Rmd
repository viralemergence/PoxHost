...
write.csv(ts1, file='Output/table_thresholdvalues_model1.csv')
...
# Visualize and select threshold to apply binary classificaiton
tree_pp_model1
...
# Save tree plot
png("Output/tree_pp_model1.png",width=12,height=8,units="in",res=300)
