...
(2) MAMMALS.shp, the shape file of mammal geographical range (for mapping - part five); and
...
#(1) Load shape file of mammal geographic range (from IUCN Red List database)  from raw datafile
