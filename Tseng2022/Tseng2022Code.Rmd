...
# Model 1: Boosted regression trees with a single response variable
...
## visualize distribution of NA
setwd("/Users/katietseng/Downloads")
png("Results/Figure S1.png", width=4,height=4,units="in",res=600)
...
## save list of covariates and their coverage as table S1
set <- subset(data,select=-c(gen,fam,ord,gtip,treename,traitname,type))
...
## save Table S1 to results
write.csv(ts1, "Results/TableS1.csv")
...
if(hok!="ok"){
  ...
  ## export
  setwd("/Users/katietseng/Downloads")
  write.csv(search,"Results/par tuning data summary.csv")
  
}else{
  
  ## load
  setwd("/Users/katietseng/Downloads")
  search=read.csv("Results/par tuning data summary.csv")
...
## visualize
setwd("/Users/katietseng/Downloads")
png("Results/Figure S2.png",width=5,height=8,units="in",res=600)
set.seed(1)
...
## write to files
setwd("/Users/katietseng/Downloads")
saveRDS(pcr_brts,"Results/pcr brts.rds")
saveRDS(comp_brts,"Results/comp brts.rds")

## run wos brts
pm_brts=lapply(1:(smax-1),function(x) brt_part(seed=x,response="cites"))

## write
saveRDS(pm_brts,"Results/pm brts.rds")
```
