...
#(1) PCA using stats::prcomp -> scaling/centering not appropriate
pca <- prcomp(mat)
...
#(3) Screeplot
fviz_eig(pca) # these values agree with pca_relvar (variance explained)
screeplot(pca, type="l", npcs=10, main="Screeplot of the first 10 PCs")  
abline(h = 1, col="red", lty=5)
legend("topright", legend=c("Eigenvalue = 1"),
       col=c("red"), lty=5, cex=0.6)
# not sure how these values are obtained)
...
abline(h = 0.77, col="blue", lty=5)
legend("topleft", legend=c("Cut-off @ PC6"),
       col=c("blue"), lty=5, cex=0.6)

#PCA variables - dim1 and 2
fviz_pca_var(pca,
