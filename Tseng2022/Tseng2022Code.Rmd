---
title: "Poxvirus Host Prediction: 01_cleaning"
author: "Katie Tseng, Dan Becker, Colin Carlson, Pilar Fernandez, Stephanie Seifert"
---
...
##(4) hostTraits: mammal traits from the COMBINE database <https://doi.org/10.1002/ecy.3344> (path: ecy3344-sup-0001-datas1.zip > COMBINE_archives > trait_data_imputed.csv)
hostTraits <- combine

##(5) hostTree: mammal phylogeny tree from Dryad, <https://doi.org/10.5061/dryad.tb03d03> (path: Data_S8_finalFigureFiles > _DATA > MamPhy_fullPosterior_BDvr_Completed_5911sp_topoCons_NDexp_MCC_v2_target.tre)
hostTree <- dryad
...
## let's add in viral genome length, viral richness (number of virus detected in each genera), and host range (number of hosts from which each virus was)
```
