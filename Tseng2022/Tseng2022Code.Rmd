...
virion <- vroom("https://github.com/viralemergence/virion/raw/main/Virion/Virion.csv.gz")

  #vertlife (taxa): mammal species taxonomy from vertlife, <https://data.vertlife.org/>
vertlife<- read.csv("https://data.vertlife.org/mammaltree/taxonomy_mamPhy_5911species.csv")
