...
##(6) viralTraits: OPV accessory genes from ...
...
# Merge poxdata with hostTraits and trim hostTree to match poxdata
...
## clean environment
rm(vars,viralTraits,keeps,original_cols,mode.prop)
...
##(5) plot eigenvalues - include coordinates
genpca <- princomp(gendist)
biplot(genpca)
