...
png("Kamiak_Results_Model2/histogram_trait_coverage.png", width=4,height=4,units="in",res=600)
...
# Save table
write.csv(trait_coverage, "Kamiak_Results_Model2/table_trait_coverage.csv")
...
if(hok!="ok"){
  ...
  write.csv(search,"Kamiak_Results_Model2/par_tuning_data_summary_Model2.csv")
  
}else{
  
  ## 
  # search=read.csv("Output/par_tuning_data_summary_Model1.csv")
  search=read.csv("Kamiak_Results_Model2/par_tuning_data_summary_Model2.csv")
...
png("Kamiak_Results_Model2/boxplot_brt_tuning.png",width=5,height=8,units="in",res=600)
set.seed(1)
...
save(brts,pm_brts,file="Kamiak_Results_Model2/brts_Model2.RData")
