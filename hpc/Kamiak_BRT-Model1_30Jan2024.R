...
png("Kamiak_Results_Model1/histogram_trait_coverage.png", width=4,height=4,units="in",res=600)
...
# Save table
write.csv(trait_coverage, "Kamiak_Results_Model1/table_trait_coverage.csv")
...
if(hok!="ok"){
  ...
  ## export
  write.csv(search,"Kamiak_Results_Model1/par_tuning_data_summary_Model1.csv")
  # write.csv(search,"Output/par_tuning_data_summary_Model2.csv")
  
}else{
  
  ## 
  search=read.csv("Kamiak_Results_Model1/par_tuning_data_summary_Model1.csv")
...
png("Kamiak_Results_Model1/boxplot_brt_tuning.png",width=5,height=8,units="in",res=600)
set.seed(1)
...
save(brts,pm_brts,file="Kamiak_Results_Model1/brts_Model1.RData")
